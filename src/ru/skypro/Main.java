...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("stringList.add(\"Word2\") = " + stringList.add("Word2"));
        System.out.println("stringList.add(index = 2 \"Word3\") = " + stringList.add(2, "Word3"));
        System.out.println("stringList.set(\"Word3\") = " + stringList.set(4, "Word3"));
        System.out.println("stringList.remove(\"Word2\") = " + stringList.remove("Word2"));
        ...
        otherStringList.add("Word4");
        otherStringList.add("Word2");
